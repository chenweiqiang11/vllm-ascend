...
from vllm_ascend.platform import _update_sfa_cache_dtype, _validate_turboquant_cache
...
def test_sfa_cache_dtype_update_preserves_turboquant() -> None:
    config = _make_config()
    _update_sfa_cache_dtype(config)
