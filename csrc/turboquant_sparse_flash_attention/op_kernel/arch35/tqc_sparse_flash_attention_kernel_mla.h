...
#include "tqc_sparse_flash_attention_common_arch35.h"
#include "tqc_sparse_flash_attention_kvcache.h"
...
namespace BaseApi {
template <typename CubeBlockType, typename VecBlockType> class TqcSparseFlashAttentionMla {
public:
    ARGS_TRAITS;
...
private:
    ...
    __gm__ uint8_t *workspace, const TqcSparseFlashAttentionTilingDataMla *__restrict tiling, TPipe *tPipe);
...
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::Init(
    ...
    TPipe *tPipe)
{
    ...
    if ASCEND_IS_AIV {
        ...
        constInfo.dSizeV = this->sharedParams.dSize - this->sharedParams.dSizeRope;
    }
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::InitCalcParamsEach()
{
    // 计算总的基本块
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline uint64_t TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::\
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::GetAxisStartIdx(uint32_t bN2EndPrev,
                                                                                uint32_t s1GEndPrev,
                                                                                uint32_t s2EndPrev)
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::InitGlobalBuffer(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::InitMMResBuf(
    __gm__ uint8_t *workspace)
{
    uint32_t mm1RightSize = constInfo.s2BaseSize * constInfo.dSize * sizeof(Q_T);
    ...
    uint32_t mm2ResultSize = constInfo.s1BaseSize / CV_RATIO * constInfo.dSizeV * sizeof(T);
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::InitLocalBuffer()
{
    vecBlock.InitLocalBuffer(pipe, constInfo);
}

template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::ComputeConstexpr()
{
    // 计算轴的乘积
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::InitUniqueConstInfo()
{
    // bsize + 1-> bsize
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::Process()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::ProcessMainLoop()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::ComputeAxisIdxByBnAndGs1(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::SetRunInfo(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::InitUniqueRunInfo(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void TqcSparseFlashAttentionMla<CubeBlockType, VecBlockType>::ComputeBmm1Tail(
