...
#include "arch35/tqc_sparse_flash_attention_kernel_mla.h"
#else
...
{
    if constexpr (ORIG_DTYPE_QUERY == DT_BF16 && ORIG_DTYPE_KEY == DT_INT8 &&
                         ORIG_DTYPE_ATTENTION_OUT == DT_BF16) {
        QSFA_OP_IMPL(BaseApi::TqcSparseFlashAttentionMla, TqcSparseFlashAttentionTilingDataMla,
