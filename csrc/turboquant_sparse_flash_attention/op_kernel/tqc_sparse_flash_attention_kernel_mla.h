...
/*!
 * \file tqc_sparse_flash_attention_kernel_mla.h
 * \brief
 */

#ifndef TQC_SPARSE_FLASH_ATTENTION_KERNEL_MLA_H
#define TQC_SPARSE_FLASH_ATTENTION_KERNEL_MLA_H
...
#include "tqc_sparse_flash_attention_service_cube_mla.h"
#include "tqc_sparse_flash_attention_service_vector_mla.h"
...
template <typename QSFAT> class TqcSparseFlashAttentionMla {
public:
    ...
    __aicore__ inline TqcSparseFlashAttentionMla(){};
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const TqcSparseFlashAttentionTilingDataMla *__restrict tiling,
...
private:
    ...
    const TqcSparseFlashAttentionTilingDataMla *__restrict tilingData = nullptr;
...
template <typename QSFAT> __aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::InitTilingData()
{
...
template <typename QSFAT> __aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::InitBuffers()
{
    if ASCEND_IS_AIV {
...
TqcSparseFlashAttentionMla<QSFAT>::InitActualSeqLen(__gm__ uint8_t *actualSeqLengthsQ,
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::InitAllZeroOutput(uint32_t bIdx, uint32_t s1Idx,
                                                                                  uint32_t n2Idx)
{
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::InitOutputSingleCore()
{
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::GetActualSeqLen(uint32_t bIdx, uint32_t s1Idx)
{
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::GetSparseActualSeqLen(uint32_t bIdx, uint32_t s1Idx,
                                                                                      uint32_t n2Idx)
{
...
template <typename QSFAT>
__aicore__ inline uint32_t TqcSparseFlashAttentionMla<QSFAT>::GetActualSeqLenKV(uint32_t bIdx)
{
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::DealActSeqLenIsZero(uint32_t bIdx, uint32_t s1Idx,
                                                                                    uint32_t n2Idx)
{
    if ASCEND_IS_AIV {
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::GetPreNextTokensLeftUp()
{
    if (constInfo.sparseMode == 3) {
...
template <typename QSFAT> __aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::UpdateInnerLoopCond()
{
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::UpdateInner(uint32_t &s2End, uint32_t &curS2End,
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::Init(__gm__ uint8_t *query,
...
template <typename QSFAT> __aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::InitCalcParamsEach()
{
    // 计算总的基本块
...
template <typename QSFAT>
__aicore__ inline void
TqcSparseFlashAttentionMla<QSFAT>::Bmm2DataCopyOut(uint64_t attenOutOffset, LocalTensor<OUT_T> &attenOutUb,
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::CalcParams(uint32_t loop, uint64_t s2Start,
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::CalcMSizeInfo(RunInfo &info)
{
    if ASCEND_IS_AIV {
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::CalcFirstTensorOffsets(
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::ComputeMm1(const RunInfo &info)
{
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::ComputeMm2(const RunInfo &info)
{
    uint32_t nBufferLoopTimes = (info.actMBaseSize + constInfo.nBufferMBaseSize - 1) / constInfo.nBufferMBaseSize;
    uint32_t nBufferTail = info.actMBaseSize - (nBufferLoopTimes - 1) * constInfo.nBufferMBaseSize;
    for (uint32_t i = 0; i < nBufferLoopTimes; i++) {
...
template <typename QSFAT> __aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::Process()
{
    if (aiCoreIdx < usedCoreNum) {
        if ASCEND_IS_AIC {
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::GetBN2Idx(uint32_t bN2Idx, uint32_t &bIdx,
                                                                          uint32_t &n2Idx)
{
...
template <typename QSFAT> __aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::ProcessBalance()
{
    RunInfo extraInfo[QSFA_PRELOAD_TASK_CACHE_SIZE];
    uint32_t gloop = 0;
    int gS1LoopEnd;
...
template <typename QSFAT>
__aicore__ inline void
TqcSparseFlashAttentionMla<QSFAT>::PreloadPipeline(uint32_t loop, uint64_t s2Start, uint64_t s2LoopIdx,
                                                         RunInfo extraInfo[QSFA_PRELOAD_TASK_CACHE_SIZE])
{
...
TqcSparseFlashAttentionMla<QSFAT>::GetBalanceActualSeqLengths(GlobalTensor<int32_t> &actualSeqLengths,
                                                                    uint32_t bIdx)
{
    if constexpr (LAYOUT_T == QSFA_LAYOUT::TND) {
        if (bIdx > 0) {
...
template <typename QSFAT>
__aicore__ inline void TqcSparseFlashAttentionMla<QSFAT>::GetAxisStartIdx(uint32_t bN2EndPrev,
...
#endif // TQC_SPARSE_FLASH_ATTENTION_KERNEL_MLA_H
